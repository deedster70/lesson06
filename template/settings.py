...
#
#  heroku config:set DJANGO_SECRET_KEY='*sskp+mw!su2ia&6$^$j+szl$vj-murqe78ulv*q1w+025ou@f'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = '*sskp+mw!su2ia&6$^$j+szl$vj-murqe78ulv*q1w+025ou@f'
...
# if the environment variable is not defined then default to template_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'template_db.sqlite3')),
}
